...
const page = () => {
  return (
    <div>
      ...
      <div className="py-4">
        <form className="bg-white dark:bg-gray-800 p-5 m-4 rounded-md dark:text-gray-200 text-gray-800">
          <div className="grid grid-cols-2 max-[650px]:grid-cols-1 gap-4">
            ...
            <div className="flex flex-col gap-1 col-span-2 max-[650px]:col-span-1">
              ...
              <input
                ...
                className="border border-[rgba(0,0,0,0.2)] dark:border-[rgba(255,255,255,0.2)] dark:bg-gray-700 outline-none focus:border-[rgba(0,0,0,0.4)] dark:focus:border-[rgba(255,255,255,0.4)] text-[14px] rounded-md px-3 py-2"
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <select className="border border-[rgba(0,0,0,0.2)] dark:border-[rgba(255,255,255,0.2)] dark:bg-gray-700 outline-none text-[14px] rounded-md px-3 py-2">
